        ...
        <div className="container-custom">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className={`w-16 h-16 ${feature.color === 'text-royal-blue' ? 'bg-royal-blue' : 'bg-orchid'} rounded-full flex items-center justify-center mx-auto mb-6`}>
        ...
        <div className="container-custom">
          <div className="text-center">
            ...
            >
              <Link 
                href="/contact" 
                className="inline-flex items-center bg-white text-orchid hover:bg-gray-100 font-semibold py-4 px-8 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Schedule Your Visit
